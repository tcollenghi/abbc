...
namespace ProjetoBase
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // CSS style (bootstrap/Material)
            bundles.Add(new StyleBundle("~/Content/cssMaterial").Include(
                      "~/Content/bootstrap.min.css",
            ...
            bundles.Add(new ScriptBundle("~/bundles/DashBoard").Include(
                                         ...
                                         "~/Scripts/aplicacao/JsDashboard.js"
                                         ));
            // Aluno
            bundles.Add(new ScriptBundle("~/bundles/Aluno").Include(
                                        "~/Scripts/aplicacao/JsAluno.js"));

            // Aluno Ficha
            bundles.Add(new ScriptBundle("~/bundles/AlunoFicha").Include(
                                        "~/Scripts/aplicacao/JsAlunoFicha.js"));

            // Curso
            bundles.Add(new ScriptBundle("~/bundles/Curso").Include(
                                        "~/Scripts/aplicacao/JsCurso.js"));

            // Curso Incluir
            bundles.Add(new ScriptBundle("~/bundles/CursoIncluir").Include(
                                        "~/Scripts/aplicacao/JsCursoIncluir.js"));

            // Turma
            bundles.Add(new ScriptBundle("~/bundles/Turma").Include(
                                        "~/Scripts/aplicacao/JsTurma.js"));

            // Turma Incuir
            bundles.Add(new ScriptBundle("~/bundles/TurmaIncluir").Include(
                                        "~/Scripts/aplicacao/JsTurmaIncluir.js"));

            // Plano de Pagamento
            bundles.Add(new ScriptBundle("~/bundles/PlanoPagamento").Include(
                                        "~/Scripts/aplicacao/JsPlanoPagamento.js"));

            // Plano de Pagamento Incluir
            bundles.Add(new ScriptBundle("~/bundles/PlanoPagamentoIncluir").Include(
                                        "~/Scripts/aplicacao/JsPlanoPagamentoIncluir.js"));

            // Gerar Boleto
            bundles.Add(new ScriptBundle("~/bundles/GerarBoleto").Include(
                                        "~/Scripts/aplicacao/JsGerarBoleto.js"));

            // Funcionario
            bundles.Add(new ScriptBundle("~/bundles/Funcionario").Include(
                                        "~/Scripts/aplicacao/JsFuncionario.js"));

            // Funcionario Incluir
            bundles.Add(new ScriptBundle("~/bundles/FuncionarioIncluir").Include(
                                        "~/Scripts/aplicacao/JsFuncionarioIncluir.js"));

            

            //Relatórios
            bundles.Add(new ScriptBundle("~/bundles/Relatorios").Include(
                                        "~/Scripts/aplicacao/JsRelatorios.js"));

            //Gráficos
            bundles.Add(new ScriptBundle("~/bundles/Graficos").Include(
                                        "~/Scripts/aplicacao/JsGraficos.js"));

            //Mailbox
            bundles.Add(new ScriptBundle("~/bundles/Mailbox").Include(
                                        "~/Scripts/aplicacao/JsMailbox.js"));

            //Acompanhar
            bundles.Add(new ScriptBundle("~/bundles/Acompanhar").Include(
                                        "~/Scripts/aplicacao/JsAcompanhar.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/material").Include(
                                          ...
                                          "~/Scripts/jquery.email-autocomplete.min.js",
                                          "~/Scripts/plugins/toastr/toastr.min.js",
                                          "~/Scripts/demo.js"));

            // Inspinia script
            var inspiniaScript = new ScriptBundle("~/bundles/inspinia").Include(
            ...
            //{
            //    inspiniaScript.Include("~/Scripts/app/UtilDSV.js");
            //}
            //else
            //{
            //    inspiniaScript.Include("~/Scripts/app/UtilPRD.js");
            //}

            bundles.Add(inspiniaScript);
